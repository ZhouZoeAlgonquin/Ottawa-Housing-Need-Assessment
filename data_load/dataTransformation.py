...
household_number_by_year.columns = ["Year",
...
household_size_by_year.columns = ["Year",
                                  "Number of Households",
                                  "Population Percentage",
                                  "Household Size",
                                  "Dwelling Type",
...
household_dwelling_type.columns = ["Year",
                                   "Number of Households",
                                   "Population Percentage",
                                   "Household Size",
                                   "Dwelling Type",
...
rent_range_by_year.columns = ["Year", "Rent Range",
...
ottawa_rent_amount_by_year.columns = ["Year",
                                      "Rent Range",
                                      "Percentage of Households",
                                      "Rent Metric Type",
                                      "Rent Amount",
...
turnover_nonTurnover_unit_rent_2022.columns = ["Year",
                                               "Rent Range",
                                               "Percentage of Households",
                                               "Rent Metric Type",
                                               "Rent Amount",
...
ottawa_urbanation_average_rent_by_fiscal_quarter.columns = ["Year",
                                                            "Rent Range",
                                                            "Percentage of Households",
                                                            "Rent Metric Type",
                                                            "Rent Amount",
...
housingStock_2021_by_dwelling_type.columns = ["Year",
                                              "Dwelling Type",
...
housingStock_2021_by_period_of_construction.columns = ["Year",
                                                       "Dwelling Type",
                                                       "Number of Occupied Dwellings",
                                                       "Period of Construction",
                                                       "Percentage of Total Occupied Dwellings"]
...
total_new_centralized_waitlist.columns = ["Year",
                                          "Number",
                                          "Percentage",
                                          "Percentage of Total Waitlist",
                                          "Chart Type",
                                          "Household Type"]
...
new_centralized_waitlist_by_household.columns = ["Year",
                                                 "Number",
                                                 "Percentage",
                                                 "Percentage of Total Waitlist",
                                                 "Chart Type",
...
total_population_group_shelter_demand.columns = ["Year",
                                                 "Number",
                                                 "Population Group",
                                                 "Shelter System Demand or Capacity?"]
...
vacancy_by_rent_range.columns = ["Year",
                                 "Unit Type",
                                 "Rent Range",
                                 "Vacancy Rate",
...
centralized_waitlist_total.columns = ["Year",
                                      "Number",
                                      "Household Type",
                                      "Indicator"]
...
centralized_waitlist_household_composition.columns = ["Year",
                                                      "Number",
                                                      "Household Type",
                                                      "Indicator"]
...
centralized_waitlist_unit_size.columns = ["Year",
                                          "Number",
                                          "Household Type",
                                          "Indicator"].copy()
...
experience_of_Homelessness.columns = ["Year",
                                      "Number",
                                      "Percentage of Total People Surveyed",
                                      "Population Group",
                                      "Data Source",
                                      "Type of Homelessness Experienced"]
...
house_centralized_waitlist_total.columns = ["Year",
                                            "Number",
                                            "Percentage of Total Waitlist",
                                            "Percentage of Annual Total Housed",
                                            "Chart Type",
                                            "Household Type"]
...
house_centralized_waitlist_household.columns = ["Year",
                                                "Number",
                                                "Percentage of Total Waitlist",
                                                "Percentage of Annual Total Housed",
                                                "Chart Type",
